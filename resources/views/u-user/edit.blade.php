        ...
        <div class="col-md-12 grid-margin stretch-card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" dir="auto" class="form-control" value="{{ $user->name }}" id="name" name="name" placeholder="" reqiured>
                </div>
                <div class="form-group">
                    <label for="email">البريد الالكتروني</label>
                    <input type="email" dir="auto" readonly class="form-control" value="{{ $user->email  }}" id="email" name="email" reqiured>
                </div>
                <div class="form-group">
