                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" dir="ltr" aria-label="Basic example">
                                            <a href="{{ auth()->user()->id == $user->id ? '#' : route('user.delete',$user->id) }}" title="حذف" class="btn btn-danger delete"><i class="mdi mdi-delete-forever" ></i></a>
...
<script>
    @if(Session::has('success'))
        $.notify({
            ...
            message: ' تم تحديث جدول المشرفين '
        },{
            // settings
            type: "success",
            allow_dismiss: false,
    ...
    @if(Session::has('error'))
        $.notify({
            ...
            icon: 'fa fa-check-circle',
            title: '<strong > تنبية  </strong> ... ',
            message: ' حثت مشكلة يرجى المحاولة لاحقاً .'
        },{
            // settings
            type: "warning",
            allow_dismiss: false,
